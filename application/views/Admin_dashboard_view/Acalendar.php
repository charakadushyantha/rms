...
eventSources: [
                   {
                       url: '<?php echo A_DASHBOARD_URL; ?>/get_events',
                       type: 'POST',
                       color: '#65a9d7',
                       textColor: '#3c3d3d'
...
eventClick: function(event, jsEvent, view) {
      $('#cid').val(event.id);
      $('#rname').val(event.Recruiter_username);
      $('#itv').val(event.Interviewer);
      $('#ir').val(event.interview_round);
      $('#cname').val(event.Can_name);
              ...
              <div class="row">
                  <div class="col-lg-12">
                      <ul class="nav nav-tabs custom-menu-wrap">
                          ...
                          <li class="active"><a href="<?php echo A_CALENDAR_URL; ?>"><i class="fa fa-calendar"></i>Calendar</a>
                          </li>
                    ...
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul class="mobile-menu-nav">
                                   ...
                                   <li><a data-toggle="collapse" data-target="#calr" href="#"><i
  ...
  <div class="modal-dialog"  role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Candidates Interview Details</h4>
      </div>
      <div class="modal-body">
      <div class="form-group">
                <label for="p-in" class="col-md-4 label-heading">Candidate Id</label>
                <div class="col-md-8 ui-front">
                  <input type="number" class="form-control" name="can_id" id="cid" readonly />
                </div>
        </div>
        <div class="form-group">
                <label for="p-in" class="col-md-4 label-heading">Candidate Name</label>
                <div class="col-md-8 ui-front">
                <input type="text" class="form-control" name="can_name" value="" id="cname" readonly >
                </div>
        </div>
        <div class="form-group">
                <label for="p-in" class="col-md-4 label-heading">Recruited By</label>
                <div class="col-md-8 ui-front">
                <input type="text" class="form-control" name="can_name"  id="rname" readonly >
                </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-md-8 ui-front">
            <div class="form-select-list">
                <select class="form-control custom-select-value" id="ir" name="interview_round" readonly >
          ...
          <div class="col-md-8 ui-front">
            <div class="form-select-list">
              <select class="form-control custom-select-value"
                  name="Interviewer" id="itv" readonly >
