...
<head>
    ...
    <link rel="stylesheet" href="<?php echo REC_ASSETS_PATH; ?>/css/form/themesaller-forms.css">
...
<body>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                  <div class="compnay-logo">
                    <a href="https://cmsads24.com/" class="clogo"><img src="<?php echo COMPANY_LOGO; ?>" alt="Henoycomb Company Logo" class="img-fluid"/></a>
                    <a href="https://cmsads24.com/" class="cname"><img src="<?php echo COMPANY_NAME; ?>" alt="Henoycomb Company Name" class="img-fluid" /></a>
                  </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="col-lg-12">
                    <ul class="nav nav-tabs custom-menu-wrap">
                       <li><a href="<?php echo R_DASHBOARD_URL; ?>"><i class="fa fa-home"></i>Home</a>
                        ...
                        <li class="active"><a href="<?php echo R_SCHEDULE_URL; ?>"><i class="fas fa-user-clock"></i>Schedule</a>
                        </li>
                    ...
                    <div class="tab-content custom-menu-content">
                      ...
                      <div id="schedule" class="tab-pane in active tab-custon-menu-bg animated flipInX">
                          <ul class="main-menu-dropdown">
  ...
  <!-- Mobile Menu end -->
                ...
                <div class="col-lg-12">
                    <div class="sparkline12-list shadow-reset mg-t-30">
                        ...
                        <div class="sparkline12-graph">
                          ...
                          {
                            echo '<div class="container-fluid"><div class="alert alert-danger" role="alert">'.$this->session->flashdata('msg').'</div></div>';
                          } ?>
                            <div class="basic-login-form-ad">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="all-form-element-inner">
                                            <form action="<?php echo R_DASHBOARD_URL; ?>/schedule_proc" method="post">
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        <div class="col-lg-3">
                                                            <label class="login2 pull-right pull-right-pro">Full
                                                                Name</label>
                                                        </div>
                                                        <div class="col-lg-9">
                                                            <input type="text" name="can_name" required class="form-control" value="<?php
                                                            if(isset($can_name)){
                                                              echo $can_name;
                                                            } ?>"/>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label
                                                                        ...
                                                                        style="font-weight: bold;">Interview
                                                                        Start Date</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" required name="sdate" class="form-control"
                                                ...
                                                <input type="text" name="can_id" hidden  value="<?php
                                                            if(isset($can_id)){
                                                              echo $can_id;
                                                            } ?>">
                                                <div class="sparkline16-graph">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="input-group">
                                                                        <span class="input-group-addon"><i
                                                                                class="fa fa-calendar"></i></span>
                                                                        <input type="text" required name="edate" class="form-control"
                                                                            placeholder="YYYY-MM-DD HH:MM:SS">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        <div class="col-lg-3">
                                                            <label
                                                                class="login2 pull-right pull-right-pro">Interviewer</label>
                                                        </div>
                                                        <div class="col-lg-9">
                                                            <div class="form-select-list">
                                                                <select class="form-control custom-select-value"
                                                                    name="Interviewer" required>
    ...
    <!-- datapicker JS
		============================================ -->
    <script src="<?php echo REC_ASSETS_PATH; ?>/js/datapicker/bootstrap-datepicker.js"></script>
    <script src="<?php echo REC_ASSETS_PATH; ?>/js/datapicker/datepicker-active.js"></script>
    <!-- timepicker js
        =========================================== -->
    <link rel="stylesheet"
        href="https://cdnjs.cloudflare.com/ajax/libs/jquery-datetimepicker/2.5.20/jquery.datetimepicker.full.js">
    <!-- sparkline JS
		============================================ -->
