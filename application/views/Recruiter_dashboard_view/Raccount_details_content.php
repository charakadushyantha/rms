...
if(isset($recruiter_details)) {
    if(is_object($recruiter_details)) {
        $email = isset($recruiter_details->u_email) ? $recruiter_details->u_email : $email;
        $phone = isset($recruiter_details->pi_phone) ? $recruiter_details->pi_phone : '';
        $gender = isset($recruiter_details->pi_gender) ? $recruiter_details->pi_gender : '';
    } elseif(is_array($recruiter_details)) {
        $email = isset($recruiter_details['u_email']) ? $recruiter_details['u_email'] : $email;
        $phone = isset($recruiter_details['pi_phone']) ? $recruiter_details['pi_phone'] : '';
        $gender = isset($recruiter_details['pi_gender']) ? $recruiter_details['pi_gender'] : '';
    }
        ...
        <div class="data-card text-center">
            <div class="py-4">
                <div class="mb-4 position-relative" style="width: 120px; margin: 0 auto;">
                    ...
                    if(isset($recruiter_details)) {
                        if(is_object($recruiter_details)) {
                            $profile_pic = isset($recruiter_details->profile_picture) ? $recruiter_details->profile_picture : '';
                        } elseif(is_array($recruiter_details)) {
                            $profile_pic = isset($recruiter_details['profile_picture']) ? $recruiter_details['profile_picture'] : '';
                        }
                    }
                    ...
                    <form id="profilePicForm" action="<?= base_url('R_dashboard/upload_profile_picture') ?>" method="post" enctype="multipart/form-data" style="display: none;">
                        <input type="file" 
                               id="profilePicInput" 
...
<div class="modal fade" id="editProfileModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('R_dashboard/update_profile') ?>" method="post" id="editProfileForm">
...
<div class="modal fade" id="changePasswordModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('R_dashboard/change_password') ?>" method="post" id="changePasswordForm">
                <div class="modal-body">
                    <div class="mb-3">
...
function uploadProfilePicture() {
    ...
    const originalContent = profileImage.innerHTML || profileImage.outerHTML;
