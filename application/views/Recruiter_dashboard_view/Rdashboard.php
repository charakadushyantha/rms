...
<head>
    ...
    <!-- Color Css Files
        ============================================ -->
    <link rel="alternate stylesheet" type="text/css" href="<?php echo REC_ASSETS_PATH; ?>/css/switcher/color-one.css"
        title="color-one" media="screen" />
    <link rel="alternate stylesheet" type="text/css" href="<?php echo REC_ASSETS_PATH; ?>/css/switcher/color-two.css"
        title="color-two" media="screen" />
    <link rel="alternate stylesheet" type="text/css" href="<?php echo REC_ASSETS_PATH; ?>/css/switcher/color-three.css"
        title="color-three" media="screen" />
    <link rel="alternate stylesheet" type="text/css" href="<?php echo REC_ASSETS_PATH; ?>/css/switcher/color-four.css"
        title="color-four" media="screen" />
    <link rel="alternate stylesheet" type="text/css" href="<?php echo REC_ASSETS_PATH; ?>/css/switcher/color-five.css"
        title="color-five" media="screen" />
    <link rel="alternate stylesheet" type="text/css" href="<?php echo REC_ASSETS_PATH; ?>/css/switcher/color-six.css"
        title="color-six" media="screen" />
    <link rel="alternate stylesheet" type="text/css" href="<?php echo REC_ASSETS_PATH; ?>/css/switcher/color-seven.css"
        title="color-seven" media="screen" />
    <link rel="alternate stylesheet" type="text/css" href="<?php echo REC_ASSETS_PATH; ?>/css/switcher/color-eight.css"
        title="color-eight" media="screen" />
    <link rel="alternate stylesheet" type="text/css" href="<?php echo REC_ASSETS_PATH; ?>/css/switcher/color-nine.css"
        title="color-nine" media="screen" />
    <link rel="alternate stylesheet" type="text/css" href="<?php echo REC_ASSETS_PATH; ?>/css/switcher/color-ten.css"
        title="color-ten" media="screen" />
    <link rel="alternate stylesheet" type="text/css" href="<?php echo REC_ASSETS_PATH; ?>/css/switcher/color-eleven.css"
        title="color-eleven" media="screen" />
    <link rel="alternate stylesheet" type="text/css" href="<?php echo REC_ASSETS_PATH; ?>/css/switcher/color-twelve.css"
        title="color-twelve" media="screen" />
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="compnay-logo">
                        <a href="https://charaka.cmsads24.com/" class="clogo"><img
                                src="<?php echo COMPANY_LOGO; ?>" alt="Company Logo" class="img-fluid" /></a>
                        <a href="https://charaka.cmsads24.com/" class="cname"><img
                                src="<?php echo COMPANY_NAME; ?>" alt="Company Name" class="img-fluid" /></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <ul class="nav navbar-nav mai-top-nav header-right-menu">
                            ...
                            <li class="nav-item">
                                ...
                                <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated flipInX">
                                    <li><a href="<?php echo R_AC_DETAILS_URL; ?>"><span
                                                class="adminpro-icon adminpro-user-rounded author-log-ic"></span>My
                                            Profile</a>
                                    </li>
                                    <li><a href="<?php echo R_LOGOUT_URL; ?>"><span
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs custom-menu-wrap">
                        ...
                        <?php
// echo '<li><a href="' . R_REPORTS_URL . '"><i class="fa fa-chart-bar"></i>Reports</a></li>';
                        ?>
                        <?php /* <li><a href="<?php echo R_REPORTS_URL; ?>"><i class="fa fa-chart-bar"></i>Reports</a></li> */ ?>
                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <!-- Ending of Candiadte tab -->
                         <!-- =============================================================== -->
                        <!-- Starting of Reports tab -->
                        <div id="reports" class="tab-pane tab-custon-menu-bg animated flipInX">
                            <ul class="main-menu-dropdown">
                                <li><a href="<?php echo R_REPORTS_URL; ?>">Reports</a></li>
                            </ul>
                        </div>
                        <!-- Ending of Reports tab -->
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul class="mobile-menu-nav">
                                ...
                                <li><a data-toggle="collapse" data-target="#cal" href="#"><i
                                ...
                                <li><a data-toggle="collapse" data-target="#add_candidate" href="#"><i
                                ...
                                <li><a data-toggle="collapse" data-target="#status" href="#"><i
                                            class="fa fa-balance-scale"></i>Status
                                        <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                ...
                                <li><a data-toggle="collapse" data-target="#schedule" href="#"><i
                                            class="fas fa-user-clock"></i>Schedule
                                        <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                ...
                                <li><a data-toggle="collapse" data-target="#selected_candidate" href="#"><i
                                            class="fas fa-user-check"></i>Selected Candidate
                                        <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
