    ...
    <div class="row">
        ...
        <div class="section1 col-md-4 w-100" style="background-color:#E4F1F9; height: 100vh;">
            <div class="imglogo container">
                <img class="clogo img-fluid mt-3" src="<?php echo COMPANY_LOGO; ?>" alt="Company Logo">
                <img class="cname img-fluid mt-4 w-50" src="<?php echo COMPANY_NAME; ?>" alt="Company Name">
            </div>
