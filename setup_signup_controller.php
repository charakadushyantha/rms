<?php
/**
 * Setup Signup Controller - Auto Database Detection
 * Run: http://localhost/rms/setup_signup_controller.php
 */
...
try {
    ...
    echo "<h1>🚀 Setting up Signup Controller</h1>";
    echo "<style>
    ...
    echo "<li><strong>Setup Checker:</strong> <a href='http://localhost/rms/check_signup_setup.php' target='_blank'>http://localhost/rms/check_signup_setup.php</a></li>";
    echo "</ul>";
    echo "</div>";

} catch (Exception $e) {
    echo "<p class='error'>❌ Error: " . $e->getMessage() . "</p>";
    echo "<p class='warning'>⚠️ Please check your database configuration in application/config/database.php</p>";
} finally {
    if (isset($conn)) {
        $conn->close();
    }
