...
-- Dumping data for table cmsadver_rmsdb.ci_sessions: ~9 rows (approximately)
...
-- Dumping data for table cmsadver_rmsdb.company_settings: ~0 rows (approximately)
...
-- Dumping data for table cmsadver_rmsdb.interviews: ~0 rows (approximately)
...
-- Dumping data for table cmsadver_rmsdb.oauth_config: ~0 rows (approximately)
...
-- Dumping data for table cmsadver_rmsdb.referral_codes: ~0 rows (approximately)
...
-- Dumping data for table cmsadver_rmsdb.signup_settings: ~0 rows (approximately)
...
INSERT INTO `users` (`u_id`, `u_username`, `u_email`, `u_profile_picture`, `profile_picture`, `u_password`, `u_role`, `u_status`, `u_created_at`, `created_at`, `created_by`, `approved_at`, `approved_by`, `rejected_at`, `rejected_by`, `rejection_reason`) VALUES
	...
	(37, 'Charaka', 'charakanibm@gmail.com', NULL, NULL, 'fe3a4038a951dea171805fc6e056c889', 'Admin', 'Active', '2025-11-17 02:18:45', '2025-11-16 21:48:45', 'self_registration', NULL, NULL, NULL, NULL, NULL);
